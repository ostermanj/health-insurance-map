    ...
    const mapView = {
        ...
        resizeMaps(){
            this.maps.forEach(function(each){
                ...
                each.fitBounds(each.originalOptions.maxBounds);
            ...
            function setMouseEvents(){
               ...
               console.log(map.getBounds());
                if ( controller.controlState.getState().zoomedStateFP !== e.features[0].properties.STATEFP ){
                    ...
                    //map.flyTo({center: map.originalCenter, zoom: map.originalZoom});
